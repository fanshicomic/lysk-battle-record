...
type ScreenshotImageProcesser struct {
}

func NewScreenshotImageProcesser() ImageProcesser {
	return &ScreenshotImageProcesser{}
}

func (p *ScreenshotImageProcesser) ProcessImage(imagePath string) (map[string]string, error) {
